...
def app():
    ...
    st.write('Things recognition: Recognizing characters from different solid things.')
    st.write("""Trees classification: Classifying simple tree images.""")
    ...
    if st.button('Start'):
        df = pd.read_csv('sari-sari.csv', header=None)
